...
<div class="site-index">
    ...
    <div id='header-inner'>
        <div class="title-wrapper" style="margin-left: 280pt">
            <h1>Ga Penting !!</h1>

        </div>
        <div class="descriptionwrapper" style="margin-left: 300pt">
            <p class="description"><span>by Futri Diny Hasri</span></p>
        </div>
        <div class="body-content">
